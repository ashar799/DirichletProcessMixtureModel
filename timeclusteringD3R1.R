...
### However the time data shows clustering based on ONe feature of the
### Let's keep the Dimension to be 3
### This program represents ad-hoc feature selection of GMM
...
beta.list <- list(0)
for ( i in 1:F){
  beta.list[[i]] <- as.vector(c((2*i),i-2))
}
